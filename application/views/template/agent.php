...
<div class="container">
   <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Agent/Advisors Reference</li>
            </ol>
...
<form name="myform" method="post" action="<?php echo base_url('admin/reference');?>" onsubmit="return validateform()">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Reference Type:</label>
            <input type="text" class="form-control" name="reference_type" id="recipient-name">
...
var reference_type=document.myform.reference_type.value;  
var discription=document.myform.discription.value;  
  
if (reference_type.length<4){  
  alert("Reference type must be at least 5 characters long.");  
  return false;  
